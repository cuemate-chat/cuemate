...
<img src="assets/logo-background.png" alt="CueMate" width="300" />

# CueMate - Intelligent Interview Training Assistant
...
English | [中文](../README.md) | [Docs](https://cuemate.chat) | [Download](https://github.com/cuemate-chat/cuemate/releases)

</div>

## Introduction

CueMate is an open-source intelligent interview assistant - an AI-driven real-time interview training tool that focuses on helping job seekers improve their interview skills and performance through systematic mock interview training and preparation.
...
1. Download the DMG installer for your chip type
2. Double-click the DMG file and follow the installation wizard (about 5 minutes)
3. Log in with the built-in account (username: `admin`, password: `cuemate`)

## Documentation

| Document | Description |
|----------|-------------|
| [Quick Start](https://cuemate.chat/guide/installation/quick-start) | Installation guide |
| [Feature Guide](https://cuemate.chat/guide/features/) | Detailed feature documentation |
| [Changelog](https://cuemate.chat/guide/changelog/) | Version history |
| [FAQ](https://cuemate.chat/guide/faq/) | Frequently asked questions |
