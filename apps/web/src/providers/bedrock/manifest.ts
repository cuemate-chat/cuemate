...
const manifest: ProviderManifest = {
  ...
  kind: 'llm',
  icon: Icon,
  iconUrl: 'assets/llm/bedrock_icon_svg',
  jumpLink: 'https://cuemate.chat/guide/models/providers/bedrock.html',
  ...
  baseModels: [
    ...
    // Claude 4.5 系列
    {
      ...
      defaultParams: [
        { label: '温度', paramKey: 'temperature', uiType: 'slider', value: '0.7', defaultValue: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大 tokens', paramKey: 'max_tokens', uiType: 'slider', value: '65536', defaultValue: '65536', extra: { min: 256, max: 65536, step: 128 } },
      ],
    },
    {
    ...
    // Claude 4 系列
    {
      ...
      defaultParams: [
        { label: '温度', paramKey: 'temperature', uiType: 'slider', value: '0.7', defaultValue: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大 tokens', paramKey: 'max_tokens', uiType: 'slider', value: '32768', defaultValue: '32768', extra: { min: 256, max: 32768, step: 128 } },
      ],
    },
    {
    ...
    },
    {
      ...
      defaultParams: [
        { label: '温度', paramKey: 'temperature', uiType: 'slider', value: '0.7', defaultValue: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大 tokens', paramKey: 'max_tokens', uiType: 'slider', value: '8192', defaultValue: '8192', extra: { min: 256, max: 8192, step: 128 } },
      ],
    },
    // Claude 3 系列
    {
      ...
      defaultParams: [
        { label: '温度', paramKey: 'temperature', uiType: 'slider', value: '0.7', defaultValue: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大 tokens', paramKey: 'max_tokens', uiType: 'slider', value: '4096', defaultValue: '4096', extra: { min: 256, max: 4096, step: 128 } },
      ],
    },
    {
    ...
    // ========== DeepSeek 系列 ==========
    {
      ...
      defaultParams: [
        { label: '温度', paramKey: 'temperature', uiType: 'slider', value: '0.7', defaultValue: '0.7', extra: { min: 0, max: 2, step: 0.1 } },
        { label: '输出最大 tokens', paramKey: 'max_tokens', uiType: 'slider', value: '8192', defaultValue: '8192', extra: { min: 256, max: 8192, step: 128 } },
      ],
    },
    {
    ...
    },
    {
      ...
      defaultParams: [
        { label: '温度', paramKey: 'temperature', uiType: 'slider', value: '0.7', defaultValue: '0.7', extra: { min: 0, max: 2, step: 0.1 } },
        { label: '输出最大 tokens', paramKey: 'max_tokens', uiType: 'slider', value: '2048', defaultValue: '2048', extra: { min: 256, max: 2048, step: 128 } },
      ],
    },
    {
