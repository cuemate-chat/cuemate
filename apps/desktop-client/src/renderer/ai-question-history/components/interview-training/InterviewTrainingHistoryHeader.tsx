...
export function InterviewTrainingHistoryHeader({ onClose, onRefresh, searchValue, onSearchChange }: WindowHeaderProps) {
  return (
    <div className="ai-window-header">
      <div className="ai-header-left">
        <History size={16} />
        <div className="ai-title">面试训练记录</div>
      </div>
