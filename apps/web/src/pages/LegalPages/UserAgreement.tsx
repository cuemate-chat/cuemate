  ...
  return (
    <div className="container mx-auto px-6 py-8 text-slate-800">
      ...
      <div className="space-y-4 leading-relaxed">
        <p>
          <strong>感谢您选择 CueMate！</strong>{' '}
          本软件为本地部署/私有部署优先的面试辅助工具与内容创作工具（以下简称“本服务”）。本协议由您与
          CueMate 团队（以下简称“我们”）订立并约束您对本服务的使用。
        </p>

        <p>
          使用或安装本软件即代表您已阅读、理解并同意受本协议全部条款的约束。如您不同意，请立即卸载并停止使用本服务。
        </p>

        <h2 className="text-lg font-semibold mt-6">一、服务定位与使用方式</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            本软件主要以 <strong>本地运行/用户自有环境部署</strong> 为主，非典型
            SaaS；您对运行环境、系统权限与数据权限拥有完全控制；
          </li>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            您对自己输入的内容与使用输出结果承担全部责任；我们对生成内容的准确性、完整性与适用性
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>本软件以本地/私有部署为主，数据在您的设备或自有环境内处理与存储</strong>
            ；除您明确选择的云端同步/第三方服务外，我们不主动汇聚您的数据；
          </li>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>本软件“按现状”提供</strong>
            ，我们不对其适销性、特定用途适用性、不中断或无错误等做任何明示或暗示担保；
          </li>
          <li>
            在法律允许的最大范围内，因使用或无法使用本服务造成的任何直接或间接损失（包括但不限于数据丢失、业务中断、利润损失、合规风险），
            <strong>均由您自行承担</strong>；
          </li>
        ...
        <p>
          为更好地提供服务，我们可能更新本协议；新版将通过站内页面展示或版本更新说明告知。您继续使用即视为接受变更。
        </p>
