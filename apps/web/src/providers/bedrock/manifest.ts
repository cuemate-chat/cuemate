  ...
  baseModels: [
    ...
    // Claude 4.5 系列
    {
      ...
      default_params: [
        ...
        { label: '输出最大tokens', param_key: 'max_tokens', ui_type: 'slider', value: '65536', default_value: '65536', extra: { min: 256, max: 65536, step: 128 } },
      ],
    },
    {
    ...
    // Claude 4 系列
    {
      ...
      default_params: [
        { label: '温度', param_key: 'temperature', ui_type: 'slider', value: '0.7', default_value: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大tokens', param_key: 'max_tokens', ui_type: 'slider', value: '32768', default_value: '32768', extra: { min: 256, max: 32768, step: 128 } },
      ],
    },
    {
    ...
    },
    {
      ...
      default_params: [
        { label: '温度', param_key: 'temperature', ui_type: 'slider', value: '0.7', default_value: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大tokens', param_key: 'max_tokens', ui_type: 'slider', value: '8192', default_value: '8192', extra: { min: 256, max: 8192, step: 128 } },
      ],
    },
    // Claude 3 系列
    {
      ...
      default_params: [
        { label: '温度', param_key: 'temperature', ui_type: 'slider', value: '0.7', default_value: '0.7', extra: { min: 0, max: 1, step: 0.1 } },
        { label: '输出最大tokens', param_key: 'max_tokens', ui_type: 'slider', value: '4096', default_value: '4096', extra: { min: 256, max: 4096, step: 128 } },
      ],
    },
    {
    ...
    },
    {
      ...
      default_params: [
        { label: '温度', param_key: 'temperature', ui_type: 'slider', value: '0.7', default_value: '0.7', extra: { min: 0, max: 2, step: 0.1 } },
        { label: '输出最大tokens', param_key: 'max_tokens', ui_type: 'slider', value: '2048', default_value: '2048', extra: { min: 256, max: 2048, step: 128 } },
      ],
    },
    {
