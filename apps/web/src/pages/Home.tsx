        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              <Button type="primary" size="large" className="!px-8" onClick={() => nav('/jobs/new')}>开始面试</Button>
      ...
      <section className="py-12">
        <div className="container grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-xl bg-white border border-slate-200 p-6 shadow-sm">
            ...
            <p className="text-slate-600">基于岗位 JD 自动生成面试题与评分维度，覆盖通用与专项能力。</p>
          </div>
          <div className="rounded-xl bg-white border border-slate-200 p-6 shadow-sm">
            <div className="flex items-center gap-2 text-lg font-semibold text-slate-900 mb-2">
              <ChatBubbleBottomCenterTextIcon className="w-5 h-5 text-blue-600" /> 实时建议
            </div>
            <p className="text-slate-600">面试过程中实时纠错与引导，强化 STAR/SCQA 结构，提升表达与逻辑。</p>
          </div>
          <div className="rounded-xl bg-white border border-slate-200 p-6 shadow-sm">
            <div className="flex items-center gap-2 text-lg font-semibold text-slate-900 mb-2">
              <ArrowTrendingUpIcon className="w-5 h-5 text-blue-600" /> 复盘成长
            </div>
            <p className="text-slate-600">关键问题复盘、亮点与改进建议沉淀为个人题库，持续提升。</p>
          </div>
        </div>
      </section>
      </div>
