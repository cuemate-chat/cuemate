...
<table>
  <tr>
    <td width="50%">
      <h3>🎯 AI 模拟面试</h3>
      <p>AI 扮演面试官角色，根据岗位 JD 和简历智能提问。支持语音对话，模拟真实面试场景，每次回答后获得即时评估和参考答案。</p>
    </td>
    <td width="50%">
      <h3>🎙️ 面试训练（LIVE）</h3>
      <p>真实面试场景的实时辅助。自动识别面试官问题（支持腾讯会议、Zoom、钉钉、飞书等），几秒内给出答案建议。</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>💬 语音提问</h3>
      <p>随时向 AI 提问技术问题或面试题，支持语音和文字输入，获得专业的回答建议。</p>
    </td>
    <td width="50%">
      <h3>📚 知识库增强</h3>
      <p>上传简历、岗位描述、面试押题，优先从个人知识库检索答案，确保回答贴合真实背景。</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>📊 面试复盘</h3>
      <p>每次面试后生成详细报告，包含五维能力雷达图、综合评分、逐题分析、改进建议。</p>
    </td>
    <td width="50%">
      <h3>🤖 多模型支持</h3>
...
<table>
  <tr>
    <td align="center" width="33%">
      <h3>🎓 模拟面试训练</h3>
      <p>AI 模拟面试官根据岗位 JD 自动提问<br />评估回答质量，给出评分和改进建议<br />针对薄弱环节反复练习</p>
    </td>
    <td align="center" width="33%">
      <h3>📝 面试准备</h3>
      <p>上传简历、项目文档构建知识库<br />创建和管理个性化面试题库<br />测试麦克风和扬声器设备</p>
    </td>
    <td align="center" width="33%">
      <h3>🚀 技能提升</h3>
      <p>训练结构化表达（STAR 法则）<br />模拟连续快速提问增强心理承受力<br />支持英语面试练习</p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center">
      <img src="docs/assets/screenshots/control-bar.png" alt="悬浮控制栏" width="400" />
      <br /><sub><b>悬浮控制栏</b></sub>
    </td>
    <td align="center">
      <img src="docs/assets/screenshots/mock-interview-window.png" alt="AI 模拟面试" width="400" />
      <br /><sub><b>AI 模拟面试</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="docs/assets/screenshots/interview-training.png" alt="面试训练" width="400" />
      <br /><sub><b>LIVE 面试训练</b></sub>
    </td>
    <td align="center">
      <img src="docs/assets/screenshots/interview-card.png" alt="面试复盘" width="400" />
      <br /><sub><b>面试复盘</b></sub>
    </td>
  </tr>
</table>
...
3. 使用内置账号登录（用户名：`admin`，密码：`cuemate`）
...
**如果 CueMate 对你有帮助，请给我们一个 ⭐ Star 支持一下！**
