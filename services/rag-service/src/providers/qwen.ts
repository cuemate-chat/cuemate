...
export class QwenEmbeddingProvider extends BaseEmbeddingProvider {
  private client: OpenAI | null = null;

  constructor(cfg: Record<string, any>) {
    super('qwen', {
      apiKey: cfg.api_key,
      baseUrl: cfg.base_url || 'https://dashscope.aliyuncs.com/compatible-mode/v1',
      // 传递其他动态字段
      ...Object.fromEntries(
  ...
  async embed(request: EmbeddingRequest): Promise<EmbeddingResponse> {
    ...
    try {
      ...
      logger.error({ err: error as any }, 'Qwen embedding failed');
      throw error;
    }
  }
}
