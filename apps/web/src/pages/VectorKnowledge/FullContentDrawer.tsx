        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                <span className="font-medium text-blue-700">来源:</span>
              ...
              <div>
                <span className="font-medium text-blue-700">创建时间:</span>
                <span className="ml-2 text-blue-900">
          ...
          <div>
            ...
            <div className="bg-gray-50 p-4 rounded-md text-sm text-gray-900 whitespace-pre-wrap min-h-[400px] max-h-[600px] overflow-y-auto border border-gray-200">
              {document.content}
            </div>
          </div>
